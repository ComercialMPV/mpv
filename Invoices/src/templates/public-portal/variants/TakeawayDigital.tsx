// src/templates/public-portal/variants/TakeawayPortal.tsx
...
const TakeawayPortal: React.FC<TakeawayProps> = ({ company, slug, services: initialServices, products: initialProducts, bundles: initialBundles }) => {
...
<section className="bg-zinc-950 pt-24 pb-32 overflow-hidden relative">
  {/* Luz ambiente focal */}
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
      ...
      <div className="lg:col-span-5 space-y-12 pt-10">
        <div className="space-y-6">
          ...
          <h1 className="text-6xl md:text-7xl xl:text-8xl font-serif italic leading-[0.9] text-white">
            A Arte do <br />
...
<div className={`fixed inset-0 z-[100] pointer-events-none ${isCartOpen ? 'pointer-events-auto' : ''}`}>
  ...
  >
    ...
    {cart.length > 0 && (
      <div className="border-t border-white/10 bg-zinc-950 p-10 space-y-8 relative">
        <div className="space-y-3">
        ...
        {(paymentMethod === 'mpesa' || paymentMethod === 'emola') && (
          <div className="flex flex-col gap-2">
            <input
              ...
              className="w-full bg-zinc-900 border border-white/10 rounded-2xl px-4 py-3 text-sm text-white outline-none focus:border-amber-500 transition-colors placeholder:text-zinc-600"
            />
