// src/templates/public-portal/variants/RestaurantPortal.tsx
...
const RestaurantPortal: React.FC<ModerPortalProps> = ({ company, slug, services: initialServices, products: initialProducts, bundles: initialBundles }) => {
