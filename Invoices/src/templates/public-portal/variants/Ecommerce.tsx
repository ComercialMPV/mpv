// src/templates/public-portal/variants/EcommercePortal.tsx
...
const EcommercePortal: React.FC<EcommerceProps> = ({ company, slug, services: initialServices, products: initialProducts, bundles: initialBundles }) => {
...
{/* Header Estilo Premium Ecommerce */}
